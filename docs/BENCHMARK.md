...
|---|---|---|---|---|---|
| vecq 4-bit | 64 ms | 1.89 | **0.961** | **514** | **5.98x** vs f32 |
...
- **Search 1.75x faster** (3.32 → 1.89 ms/q): the scoring loop now uses a
...
- **Search throughput**: 8x slower than HNSW at n=2,000 (1.89 vs 0.23 ms/q).
